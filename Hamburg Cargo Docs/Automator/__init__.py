...
def makeCargoDocs(containers, driver):
    for container in containers:
        ...
        if container.properties[CCN] != "":
            ...
            driver.find_element_by_id("ccnDocumentNumberForm.documentNumberWithoutClientCode").send_keys("PARS")
...
#         driver.fin
        ...
        while not clicked:
            try:
                Select(driver.find_element_by_id("countrySelected2")).select_by_visible_text("United States of America")
                clicked=True
            except:
                pass
...
if __name__ == '__main__':
    ...
    argv = r"a J:\All motor routings\MAERSK_DENVER_1902_.xlsx".split()
